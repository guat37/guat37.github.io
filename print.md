...
<div class="print-page">
  ...
  <aside class="sidebar">
    ...
    <div class="avatar-mini">
      <img src="{{ profile.avatar_url | relative_url }}" alt="Photo">
    </div>
    ...
    <div class="side-section">
      ...
      <ul class="side-list">
        ...
        <li>{{ profile.website_label }}</li>
        <li>LinkedIn {{ profile.linkedin_label }}</li>
      </ul>
    </div>

    <div class="side-section">
      <div class="side-title">Domaines</div>
      <ul class="side-list">
        {% for zone in profile.premium.expertise_zones limit:7 %}
          <li>{{ zone.name }}</li>
        {% endfor %}
      </ul>
    </div>
    ...
    <div class="side-section">
      ...
      <ul class="side-list">
        {% for t in profile.skills.tools limit:7 %}
          <li>{{ t }}</li>
        {% endfor %}
      </ul>
    </div>

    {% if profile.certifications and profile.certifications.size > 0 %}
    <div class="side-section">
      <div class="side-title">Certifications</div>
      <ul class="side-list">
        {% for c in profile.certifications limit:3 %}
          <li>{{ c.name }}{% if c.org %} — {{ c.org }}{% endif %}</li>
        {% endfor %}
      </ul>
    </div>
    {% endif %}
  ...
  <section class="content">
    ...
    <div class="block">
      ...
      {% for p in profile.projects limit:2 %}
        <div class="item">
    ...
    <div class="block">
      ...
      {% for e in profile.education limit:2 %}
        <div class="item">
